/**
 * zbc-inbox Worker: an agent-accessible inbox for mail.cedarpad.com.
 *
...
export default {
  ...
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    if (pathname === '/api/send' && request.method === 'POST') {
      ...
      const headers: Record<string, string> | undefined = body.inReplyTo
      ...
      return json({ ok: true, from, to: body.to })
    }
