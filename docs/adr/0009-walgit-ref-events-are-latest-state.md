...
- **The handshake answers the question before any event fires.** A subscriber sends its watch list and is told current state immediately, which makes connect and catch-up the same operation.
